...
For using the _Prettier_ extension, see the _VS Code_ section of the [Prettier](https://michaelcurrin.github.io/code-cookbook/recipes/javascript/format-and-lint/prettier.html) page.
